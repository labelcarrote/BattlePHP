...
<html>
	<head>
		...
		<link rel="stylesheet" href="{$current_app_url}public/css/ground.css">
		<script type="text/javascript" src="{$root_url}lib/jquery/jquery-1.10.2.min.js"></script>
		<script type="text/javascript" src="{$current_app_url}public/js/ground.js?var={rand(1, 2000)}"></script>
	</head>
	<body>
		<img class="centered_img hidden" alt="" src="">
		<form class="ground_api_form" action="{$current_app_virtual_url}api"></form>
